...
** Path
   #+begin_src emacs-lisp :tangle yes
     ...
     (setq exec-path (append exec-path '("/Library/TeX/texbin" "/usr/bin" "/bin" "/usr/bin" "/usr/local/bin" "/sbin" "/usr/local/lib/pkgconfig")))
     (setenv "PATH" (concat (getenv "PATH") "/usr/local/bin:/bin:/usr/bin:/usr/sbin:/usr/local/sbin:/Library/TeX/texbin:/usr/local/lib/pkgconfig"))
   #+end_src
** Window
*** general
  #+begin_src emacs-lisp :tangle yes
