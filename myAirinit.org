	 ...
	 '(
	   ("n" "Notes")
	    ("nR" "reading" entry (file+headline "~/Dropbox/Doc/Life/org/cNotes.org" "Reading")
			       "** %? ")
	    ("nA" "agriculture" entry (file+headline "~/Dropbox/Doc/Life/org/cNotes.org" "Agriculture")
			       "** %? ")	    
	    ...
	    ("ni" "iLife" entry (file+headline "~/Dropbox/Doc/Life/org/cNotes.org" "iLife")
			       "** %? ")
	    ("j" "Journal & FarmNote")
	    ("jj" "Journal" entry (file+datetree "~/Dropbox/Doc/Life/org/journal.org")
			       "* %?\n insert on: %U %i")
	    ("jf" "DongFarmNote" entry (file+datetree "~/Dropbox/Doc/Life/org/dFarmNote.org")
			       "* %?\n 메모: %? ")
	    ("c" "Contacts")
